    ...
    <section className="bg-[#f4f5f7] py-16 md:py-20">
              ...
              <div className="p-6">
                <div className="mb-5 flex flex-wrap items-center gap-4 text-sm text-gray-500">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="font-medium text-[#3b4861]">
                      {post.author}
                    </span>
                  </div>
                ...
                <h3 className="min-h-20 text-2xl font-extrabold leading-tight text-(--primary) md:text-3xl">
                  {post.title}
                </h3>
                ...
                <button
                  ...
                  className="mt-4 text-sm font-bold text-emerald-700 hover:text-emerald-600"
                >
                  Read full article →
                </button>

                <div className="mt-6 flex items-center justify-between border-t border-gray-100 pt-6 text-(--textMuted)">
                  <div className="flex items-center gap-3">
      ...
      <div className="mt-16 bg-[#071d4a] py-16 text-center text-white">
        ...
        <button
          ...
          className="mt-8 rounded-xl bg-emerald-600 px-9 py-4 text-lg font-bold text-white transition hover:bg-emerald-500"
        >
          Join With Us
        </button>
      </div>
